...
public class DragonBones_UnityArmatureComponentWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("animationPlayer", get_animationPlayer, null);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_animationPlayer(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			DragonBones.UnityArmatureComponent obj = (DragonBones.UnityArmatureComponent)o;
			DragonBones.Animation ret = obj.animationPlayer;
			ToLua.PushObject(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index animationPlayer on a nil value");
		}
	}
